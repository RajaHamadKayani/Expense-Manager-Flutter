...
import 'package:expense_manager/screens/expense/category_screen/category.dart';
import 'package:expense_manager/screens/expense/category_screen/category_subscreen.dart';
...
class ExpenseScreenState extends State<ExpenseScreen> {
  static String replacedValue = "Please Select or add Method";
  static String ssss = "";
  static String replacedValue2 = "Uncategorized";
  static String ssss2 = "";
  static String replacedValue3 = "Enter";
  static String ssss3 = "";
  ...
  Widget build(BuildContext context) {
    // final String? replacedValue2=ModalRoute.of(context)?.settings.arguments as String?;
    return Scaffold(
      appBar: AppBar(
            ...
            child: PopupMenuButton(
              onSelected: (result) {
                if (result == 2) {
                          ...
                          TextButton(
                              onPressed: () {
                                StoreRedirect.redirect(
                                  androidAppId:
                                      "com.srowen.bs.android.simple&hl=en&gl=US",
                                );
                              },
                              child: const Text(
                                "YES",
                      ...
                      return AlertDialog(
                        ...
                        content: SingleChildScrollView(
                          ...
                          children: [
                            TextFormField(
                              decoration:
                                  const InputDecoration(hintText: "Mileage"),
                            ),
                            const SizedBox(
                              height: 20,
                            ),
                            ...
                            const Text(
                                "Note:mileage number saves in Ref No. Field")
                          ],
                        )),
                        actions: [
                          TextButton(
                  ...
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => const SetDefault()));
                }
              },
              itemBuilder: (context) => [
                PopupMenuItem(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      print("objectobject : ssss :}");
                      ssss3 = await Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => CalculatorScreen()));
                      print("objectobject : ssss : ${ssss}");
                      setState(() {
                        if (ssss3 != null && ssss3 != "") {
                          replacedValue3 = ssss3;
                        }
                      });
                    },
                    child: Text(
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      print("objectobject : ssss :}");
                      ssss = await Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => PayeeList()));
                      print("objectobject : ssss : ${ssss}");
                      setState(() {
                        if (ssss != null && ssss != "") {
                          replacedValue = ssss;
              ...
              child: Row(
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      print("objectobject : ssss :}");
                       ssss2 = await Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>DropDownHelper()));
                      print("objectobject : ssss : ${ssss2}");
                      setState(() {
                        if (ssss2 != null && ssss2 != "") {
                          replacedValue2 = ssss2;
                        }
                      });
                    },
                    child: Text(
                      ...
                      showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              title: const Text("Alert"),
                              content: const Text(
                                  "Please Enter Valid number in Amount field!"),
                              actions: [
                                TextButton(
                                    onPressed: () {
                                      Navigator.pop(context);
